...
struct UUserWidget_PlayAnimationForDuration_Params
{
	class UWidgetAnimation*                            InAnimation;                                              // (Parm, ZeroConstructor, InstancedReference, IsPlainOldData)
...
struct UWidgetComponent_SetOverrideMaterial_Params
{
...
struct UTextBlock_SetUseGlobalGlowColor_Params
{
...
struct UTextBlock_SetGlowColor_Params
{
...
struct UTextBlock_SetDisableAutoTextWidthAdjustment_Params
{
...
struct UImage_SetUseGlobalGlowColor_Params
{
...
struct UImage_SetGlowColor_Params
{
	struct FSlateColor                                 InColor;                                                  // (Parm)
};
