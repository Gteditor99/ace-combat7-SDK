...
{
public:
	struct FScriptMulticastDelegate                    OnInstanceTakePointDamage;                                // 0x0960(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnInstanceTakeRadialDamage;                               // 0x0970(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
public:
	...
	struct FBodyInstance                               BodyInstance;                                             // 0x0140(0x0230) (Edit)
	TEnumAsByte<EHasCustomNavigableGeometry>           CustomNavigableGeometry;                                  // 0x0370(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	struct FLightingChannels                           LightingChannels;                                         // 0x0371(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      UnknownData10[0x2];                                       // 0x0372(0x0002) MISSED OFFSET
	unsigned char                                      bRenderCustomDepth : 1;                                   // 0x0374(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	...
	unsigned char                                      UnknownData13[0xA];                                       // 0x0436(0x000A) MISSED OFFSET
...
{
public:
	TArray<class UMaterialInterface*>                  OverrideMaterials;                                        // 0x0440(0x0010) (Edit, ZeroConstructor)
	class UClass*                                      ComponentClass;                                           // 0x0450(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
