...
// Function UMG.UserWidget.PlayAnimationForDuration
// (Final, BlueprintCosmetic, Native, Public, BlueprintCallable)
// Parameters:
// class UWidgetAnimation*        InAnimation                    (Parm, ZeroConstructor, InstancedReference, IsPlainOldData)
// float                          StartPercentage                (Parm, ZeroConstructor, IsPlainOldData)
// float                          EndPercentage                  (Parm, ZeroConstructor, IsPlainOldData)
// float                          Duration                       (Parm, ZeroConstructor, IsPlainOldData)

void UUserWidget::PlayAnimationForDuration(class UWidgetAnimation* InAnimation, float StartPercentage, float EndPercentage, float Duration)
{
	static auto fn = UObject::FindObject<UFunction>("Function UMG.UserWidget.PlayAnimationForDuration");

	UUserWidget_PlayAnimationForDuration_Params params;
	params.InAnimation = InAnimation;
	params.StartPercentage = StartPercentage;
	params.EndPercentage = EndPercentage;
...
// Function UMG.WidgetComponent.SetOverrideMaterial
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// class UMaterialInterface*      InMaterial                     (Parm, ZeroConstructor, IsPlainOldData)

void UWidgetComponent::SetOverrideMaterial(class UMaterialInterface* InMaterial)
{
	static auto fn = UObject::FindObject<UFunction>("Function UMG.WidgetComponent.SetOverrideMaterial");

	UWidgetComponent_SetOverrideMaterial_Params params;
...
// Function UMG.TextBlock.SetUseGlobalGlowColor
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// bool                           InUseGlobalGlowColor           (Parm, ZeroConstructor, IsPlainOldData)

void UTextBlock::SetUseGlobalGlowColor(bool InUseGlobalGlowColor)
{
	static auto fn = UObject::FindObject<UFunction>("Function UMG.TextBlock.SetUseGlobalGlowColor");

	UTextBlock_SetUseGlobalGlowColor_Params params;
	params.InUseGlobalGlowColor = InUseGlobalGlowColor;
...
// Function UMG.TextBlock.SetGlowColor
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// struct FSlateColor             InColor                        (Parm)

void UTextBlock::SetGlowColor(const struct FSlateColor& InColor)
{
	static auto fn = UObject::FindObject<UFunction>("Function UMG.TextBlock.SetGlowColor");

	UTextBlock_SetGlowColor_Params params;
...
// Function UMG.TextBlock.SetDisableAutoTextWidthAdjustment
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// bool                           InFlag                         (Parm, ZeroConstructor, IsPlainOldData)

void UTextBlock::SetDisableAutoTextWidthAdjustment(bool InFlag)
{
	static auto fn = UObject::FindObject<UFunction>("Function UMG.TextBlock.SetDisableAutoTextWidthAdjustment");

	UTextBlock_SetDisableAutoTextWidthAdjustment_Params params;
...
// Function UMG.Image.SetUseGlobalGlowColor
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// bool                           InUseGlobaleGlowColor          (Parm, ZeroConstructor, IsPlainOldData)

void UImage::SetUseGlobalGlowColor(bool InUseGlobaleGlowColor)
{
	static auto fn = UObject::FindObject<UFunction>("Function UMG.Image.SetUseGlobalGlowColor");

	UImage_SetUseGlobalGlowColor_Params params;
	params.InUseGlobaleGlowColor = InUseGlobaleGlowColor;
...
// Function UMG.Image.SetGlowColor
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// struct FSlateColor             InColor                        (Parm)

void UImage::SetGlowColor(const struct FSlateColor& InColor)
{
	static auto fn = UObject::FindObject<UFunction>("Function UMG.Image.SetGlowColor");

	UImage_SetGlowColor_Params params;
	params.InColor = InColor;
