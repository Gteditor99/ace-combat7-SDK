...
public:
	...
	unsigned char                                      UnknownData01[0x7];                                       // 0x01A5(0x0007) MISSED OFFSET
	unsigned char                                      UnknownData02 : 1;                                        // 0x01AC(0x0001)
	...
	void PlayAnimationForDuration(class UWidgetAnimation* InAnimation, float StartPercentage, float EndPercentage, float Duration);
...
public:
	...
	bool                                               AutoWrapText;                                             // 0x0101(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      UnknownData00[0x1E8];                                     // 0x01C0(0x01E8) MISSED OFFSET
...
{
public:
	class UClass*                                      WidgetClass;                                              // 0x0720(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	struct FIntPoint                                   DrawSize;                                                 // 0x0728(0x0008) (Edit, IsPlainOldData)
	bool                                               bManuallyRedraw;                                          // 0x0730(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bRedrawRequested;                                         // 0x0731(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x0732(0x0002) MISSED OFFSET
	float                                              RedrawTime;                                               // 0x0734(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x8];                                       // 0x0738(0x0008) MISSED OFFSET
	struct FIntPoint                                   CurrentDrawSize;                                          // 0x0740(0x0008) (IsPlainOldData)
	bool                                               bDrawAtDesiredSize;                                       // 0x0748(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x0749(0x0003) MISSED OFFSET
	struct FVector2D                                   Pivot;                                                    // 0x074C(0x0008) (Edit, IsPlainOldData)
	bool                                               bReceiveHardwareInput;                                    // 0x0754(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bWindowFocusable;                                         // 0x0755(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x2];                                       // 0x0756(0x0002) MISSED OFFSET
	class ULocalPlayer*                                OwnerPlayer;                                              // 0x0758(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FLinearColor                                BackgroundColor;                                          // 0x0760(0x0010) (Edit, IsPlainOldData)
	struct FLinearColor                                TintColorAndOpacity;                                      // 0x0770(0x0010) (Edit, IsPlainOldData)
	float                                              OpacityFromTexture;                                       // 0x0780(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	EWidgetBlendMode                                   BlendMode;                                                // 0x0784(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bIsTwoSided;                                              // 0x0785(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x2];                                       // 0x0786(0x0002) MISSED OFFSET
	class UMaterialInterface*                          OverrideMaterial;                                         // 0x0788(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bEnableUnmodifiedTranslucency;                            // 0x0790(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bEnableUnmodifiedTranslucencyGlow;                        // 0x0791(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData05[0x2];                                       // 0x0792(0x0002) MISSED OFFSET
	float                                              DrawScale;                                                // 0x0794(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              RefreshFPS;                                               // 0x0798(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x4];                                       // 0x079C(0x0004) MISSED OFFSET
	float                                              NimbusDeltaTimeScale;                                     // 0x07A0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x2];                                       // 0x07A4(0x0002) MISSED OFFSET
	bool                                               bEnableHitTester;                                         // 0x07A6(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0x1];                                       // 0x07A7(0x0001) MISSED OFFSET
	bool                                               TickWhenOffscreen;                                        // 0x07A8(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData09[0x7];                                       // 0x07A9(0x0007) MISSED OFFSET
	class UUserWidget*                                 Widget;                                                   // 0x07B0(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, DuplicateTransient, IsPlainOldData)
	unsigned char                                      UnknownData10[0x20];                                      // 0x07B8(0x0020) MISSED OFFSET
	class UBodySetup*                                  BodySetup;                                                // 0x07D8(0x0008) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	class UMaterialInterface*                          TranslucentMaterial;                                      // 0x07E0(0x0008) (ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          TranslucentMaterial_OneSided;                             // 0x07E8(0x0008) (ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          TranslucentMaterial_Unmodified_OneSided;                  // 0x07F0(0x0008) (ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          TranslucentMaterial_UnmodifiedGlow_OneSided;              // 0x07F8(0x0008) (ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          OpaqueMaterial;                                           // 0x0800(0x0008) (ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          OpaqueMaterial_OneSided;                                  // 0x0808(0x0008) (ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          MaskedMaterial;                                           // 0x0810(0x0008) (ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          MaskedMaterial_OneSided;                                  // 0x0818(0x0008) (ZeroConstructor, IsPlainOldData)
	class UTextureRenderTarget2D*                      RenderTarget;                                             // 0x0820(0x0008) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	bool                                               bEnableDownsampleRenderTarget;                            // 0x0828(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData11[0x7];                                       // 0x0829(0x0007) MISSED OFFSET
	class UTextureRenderTarget2D*                      DownsampledRenderTargetArray[0x2];                        // 0x0830(0x0008) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	class UTextureRenderTarget2D*                      GlowRenderTarget;                                         // 0x0840(0x0008) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	class UMaterialInstanceDynamic*                    GlowMaterialInstance;                                     // 0x0848(0x0008) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	class UMaterialInstanceDynamic*                    MaterialInstance;                                         // 0x0850(0x0008) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	bool                                               bAddedToScreen;                                           // 0x0858(0x0001) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	bool                                               bEditTimeUsable;                                          // 0x0859(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData12[0x6];                                       // 0x085A(0x0006) MISSED OFFSET
	struct FName                                       SharedLayerName;                                          // 0x0860(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                LayerZOrder;                                              // 0x0868(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	EWidgetGeometryMode                                GeometryMode;                                             // 0x086C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData13[0x3];                                       // 0x086D(0x0003) MISSED OFFSET
	float                                              CylinderArcAngle;                                         // 0x0870(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData14[0x2C];                                      // 0x0874(0x002C) MISSED OFFSET
...
public:
	...
	struct FSlateColor                                 GlowColor;                                                // 0x0170(0x0028) (Edit, BlueprintVisible, BlueprintReadOnly)
	bool                                               bUseGlobalGlowColor;                                      // 0x0198(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bIsTextHidingEnable;                                      // 0x0199(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x019A(0x0002) MISSED OFFSET
	float                                              TextHidingDelay;                                          // 0x019C(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	int                                                TextHidingGroupID;                                        // 0x01A0(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bIsTextHidingDescriptionTextException;                    // 0x01A4(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0xE];                                       // 0x01A5(0x000E) MISSED OFFSET
	bool                                               bDisableAutoTextWidthAdjustment;                          // 0x01B3(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	...
	struct FSlateFontInfo                              Font;                                                     // 0x01C8(0x0058) (Edit, BlueprintVisible, BlueprintReadOnly)
	...
	struct FScriptDelegate                             ShadowColorAndOpacityDelegate;                            // 0x0238(0x0014) (ZeroConstructor, InstancedReference)
	...
	unsigned char                                      UnknownData03[0x13];                                      // 0x024D(0x0013) MISSED OFFSET
	...
	void SetUseGlobalGlowColor(bool InUseGlobalGlowColor);
	void SetText(const struct FText& InText);
	void SetShadowOffset(const struct FVector2D& InShadowOffset);
	void SetShadowColorAndOpacity(const struct FLinearColor& InShadowColorAndOpacity);
	void SetOpacity(float InOpacity);
	void SetJustification(TEnumAsByte<ETextJustify> InJustification);
	void SetGlowColor(const struct FSlateColor& InColor);
	void SetFont(const struct FSlateFontInfo& InFontInfo);
	void SetDisableAutoTextWidthAdjustment(bool InFlag);
...
public:
	...
	struct FSlateColor                                 GlowColor;                                                // 0x01A0(0x0028) (Edit, BlueprintVisible, BlueprintReadOnly)
	bool                                               bUseGlobalGlowColor;                                      // 0x01C8(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bBlendUsePreMultiplyAlpha;                                // 0x01C9(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x6];                                       // 0x01CA(0x0006) MISSED OFFSET
	struct FScriptDelegate                             OnMouseButtonDownEvent;                                   // 0x01D0(0x0014) (Edit, ZeroConstructor, InstancedReference)
	bool                                               bIsImageHidingEnable;                                     // 0x01E0(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x01E1(0x0003) MISSED OFFSET
	float                                              ImageHidingDelay;                                         // 0x01E4(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	int                                                ImageHidingGroupID;                                       // 0x01E8(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x14];                                      // 0x01EC(0x0014) MISSED OFFSET
	...
	void SetUseGlobalGlowColor(bool InUseGlobaleGlowColor);
	void SetOpacity(float InOpacity);
	void SetGlowColor(const struct FSlateColor& InColor);
	void SetColorAndOpacity(const struct FLinearColor& InColorAndOpacity);
...
public:
	...
	struct FTextBlockStyle                             TextStyle;                                                // 0x0330(0x01D8) (Edit, BlueprintVisible)
	struct FInputChord                                 SelectedKey;                                              // 0x0508(0x0020) (BlueprintVisible, BlueprintReadOnly)
	struct FSlateFontInfo                              Font;                                                     // 0x0528(0x0058) (Deprecated)
	struct FMargin                                     Margin;                                                   // 0x0580(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly)
	struct FLinearColor                                ColorAndOpacity;                                          // 0x0590(0x0010) (Deprecated, IsPlainOldData)
	struct FText                                       KeySelectionText;                                         // 0x05A0(0x0018) (Edit, BlueprintVisible, BlueprintReadOnly)
	struct FText                                       NoKeySpecifiedText;                                       // 0x05B8(0x0018) (Edit, BlueprintVisible, BlueprintReadOnly)
	bool                                               bAllowModifierKeys;                                       // 0x05D0(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bAllowGamepadKeys;                                        // 0x05D1(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x6];                                       // 0x05D2(0x0006) MISSED OFFSET
	TArray<struct FKey>                                EscapeKeys;                                               // 0x05D8(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	struct FScriptMulticastDelegate                    OnKeySelected;                                            // 0x05E8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnIsSelectingKeyChanged;                                  // 0x05F8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
public:
	...
	struct FTextBlockStyle                             WidgetStyle;                                              // 0x0160(0x01D8) (Edit, BlueprintVisible)
	bool                                               bIsReadOnly;                                              // 0x0338(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0339(0x0007) MISSED OFFSET
	struct FSlateFontInfo                              Font;                                                     // 0x0340(0x0058) (Deprecated)
	bool                                               AllowContextMenu;                                         // 0x0398(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x7];                                       // 0x0399(0x0007) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnTextChanged;                                            // 0x03A0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnTextCommitted;                                          // 0x03B0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
public:
	...
	struct FTextBlockStyle                             TextStyle;                                                // 0x0888(0x01D8) (Edit, BlueprintVisible)
	bool                                               bIsReadOnly;                                              // 0x0A60(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               AllowContextMenu;                                         // 0x0A61(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x6];                                       // 0x0A62(0x0006) MISSED OFFSET
	class USlateWidgetStyleAsset*                      Style;                                                    // 0x0A68(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
	struct FSlateFontInfo                              Font;                                                     // 0x0A70(0x0058) (Deprecated)
	struct FLinearColor                                ForegroundColor;                                          // 0x0AC8(0x0010) (Deprecated, IsPlainOldData)
	struct FLinearColor                                BackgroundColor;                                          // 0x0AD8(0x0010) (Deprecated, IsPlainOldData)
	struct FLinearColor                                ReadOnlyForegroundColor;                                  // 0x0AE8(0x0010) (Deprecated, IsPlainOldData)
	struct FScriptMulticastDelegate                    OnTextChanged;                                            // 0x0AF8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnTextCommitted;                                          // 0x0B08(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData01[0x10];                                      // 0x0B18(0x0010) MISSED OFFSET
...
// Class UMG.UMGNormalizedSequencePlayer
// 0x0000 (0x0780 - 0x0780)
class UUMGNormalizedSequencePlayer : public UUMGSequencePlayer
{
public:

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class UMG.UMGNormalizedSequencePlayer");
		return ptr;
	}
...
{
public:
	struct FScriptMulticastDelegate                    OnHoveredWidgetChanged;                                   // 0x02F0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData00[0x10];                                      // 0x0300(0x0010) MISSED OFFSET
	int                                                VirtualUserIndex;                                         // 0x0310(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              PointerIndex;                                             // 0x0314(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ECollisionChannel>                     TraceChannel;                                             // 0x0318(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0319(0x0003) MISSED OFFSET
	float                                              InteractionDistance;                                      // 0x031C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EWidgetInteractionSource                           InteractionSource;                                        // 0x0320(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bEnableHitTesting;                                        // 0x0321(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bShowDebug;                                               // 0x0322(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x1];                                       // 0x0323(0x0001) MISSED OFFSET
	struct FLinearColor                                DebugColor;                                               // 0x0324(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	unsigned char                                      UnknownData03[0x7C];                                      // 0x0334(0x007C) MISSED OFFSET
	struct FHitResult                                  CustomHitResult;                                          // 0x03B0(0x0090) (Transient, IsPlainOldData)
	struct FVector2D                                   LocalHitLocation;                                         // 0x0440(0x0008) (Transient, IsPlainOldData)
	struct FVector2D                                   LastLocalHitLocation;                                     // 0x0448(0x0008) (Transient, IsPlainOldData)
	class UWidgetComponent*                            HoveredWidgetComponent;                                   // 0x0450(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	struct FHitResult                                  LastHitResult;                                            // 0x0458(0x0090) (Transient, IsPlainOldData)
	bool                                               bIsHoveredWidgetInteractable;                             // 0x04E8(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
	bool                                               bIsHoveredWidgetFocusable;                                // 0x04E9(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
	bool                                               bIsHoveredWidgetHitTestVisible;                           // 0x04EA(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
