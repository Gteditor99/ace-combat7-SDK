...
struct FAnimNode_AimOffsetLookAt : public FAnimNode_BlendSpacePlayer
{
	...
	struct FVector                                     SocketAxis;                                               // 0x0168(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	float                                              Alpha;                                                    // 0x0174(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FBoneReference                              SocketBoneReference;                                      // 0x0178(0x0018)
...
struct FAnimNode_MakeDynamicAdditive : public FAnimNode_Base
{
	struct FPoseLink                                   Base;                                                     // 0x0030(0x0018) (Edit, BlueprintVisible)
	struct FPoseLink                                   Additive;                                                 // 0x0048(0x0018) (Edit, BlueprintVisible)
	bool                                               bMeshSpaceAdditive;                                       // 0x0060(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
struct FAnimNode_ScaleChainLength : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData01[0x3];                                       // 0x0081(0x0003) MISSED OFFSET
	struct FVector                                     TargetLocation;                                           // 0x0084(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	float                                              Alpha;                                                    // 0x0090(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
