...
public:
	...
	bool                                               bStartFromVRHangar;                                       // 0x010B(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
	bool                                               bStartInAR;                                               // 0x010C(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
