...
// Enum UMG.EWidgetShape
enum class EWidgetShape : uint8_t
{
	EWidgetShape__Quad             = 0,
	EWidgetShape__ThreePieceFolding = 1,
	EWidgetShape__Curved3D         = 2,
	EWidgetShape__EWidgetShape_MAX = 3
};
